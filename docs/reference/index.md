...
Intratumoral vs peritumoral niche identification and testing

- [`run_niche_pipeline()`](run_niche_pipeline.md) : Run Spatial Niche
  Pipeline for One Compartment
- [`run_niche_stat_tests()`](run_niche_stat_tests.md) : Run Niche
  Differential Tests Between pCR Groups
- [`run_niche_univariate_lr()`](run_niche_univariate_lr.md) : Run
  Univariate Logistic Regression for Each Niche
- [`plot_niche_stacked_composition()`](plot_niche_stacked_composition.md)
  : Plot Patient Niche Stacked Composition
- [`plot_niche_grouped_bars()`](plot_niche_grouped_bars.md) : Plot
  Grouped Niche Bars for pCR vs non-pCR
- [`plot_niche_coefficients()`](plot_niche_coefficients.md) : Plot Niche
