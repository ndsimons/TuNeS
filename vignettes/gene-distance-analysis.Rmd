---
title: "Gene-Distance Analysis"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Gene-Distance Analysis}
...
This adds `dist_to_boundary` and `abs_dist_to_boundary` metadata columns. Negative values indicate intratumoral cells, positive values indicate peritumoral/stromal cells.
...
dist_plots$trends
```
![](dist_plots_volcano.png)
![](dist_plots_trends.png)
...
The `exclude_tcell_labels` parameter removes T cells themselves from the analysis, focusing on how neighboring cells respond to T-cell proximity.
...
- [Niche Analysis](niche-analysis.html) — intratumoral vs peritumoral niche identification and statistical testing
- [Visualization](visualization.html) — comprehensive plotting functions
